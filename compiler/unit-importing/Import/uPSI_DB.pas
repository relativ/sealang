...
begin
  ...
  begin
    RegisterMethod('Procedure Open0;');
...
begin
  ...
  CL.AddClassN(CL.FindClass('TOBJECT'),'TFieldOptions');
  ...
  CL.AddTypeS('TFieldType', '( ftUnknown, ftString, ftSmallint, ftInteger, ftWo'
   ...
   +'deChar, ftWideMemo, ftOraTimeStamp, ftOraInterval, ftLongWord, ftShortint,'
  ...
  CL.AddTypeS('TFieldsAutoCreationMode', '( acExclusive, acCombineComputed, acC'
   +'ombineAlways )');
  CL.AddTypeS('TFieldsPositionMode', '( poLast, poFirst, poFieldNo )');
  CL.AddTypeS('TFieldLifeCycle', '( lcAutomatic, lcPersistent )');
  CL.AddTypeS('TFieldLifeCycles', 'set of TFieldLifeCycle');
...
begin
  ...
  begin
    RegisterMethod(@TCustomConnectionOpen0_P, 'Open0');
