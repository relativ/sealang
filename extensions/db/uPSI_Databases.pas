...
function PSPluginCreate(): TPSPlugin; stdcall;
var
  Import: TPSImport_Databases;
begin
  Import:= TPSImport_Databases.Create(nil);
  Result := Import;
end;
...
(*----------------------------------------------------------------------------*)
procedure TFieldNodeAsLargeInt_W(Self: TFieldNode; const T: LongInt);
begin Self.AsLargeInt := T; end;

(*----------------------------------------------------------------------------*)
procedure TFieldNodeAsLargeInt_R(Self: TFieldNode; var T: LongInt);
